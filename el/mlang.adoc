...
//el (defun run-multilang (fn)
//el   (interactive "P")
//el   (format "runsc Multilang %s" fn))
//el ;; you probably want: (format "multilang %s" fn)
//el 
----
...
//el   (let* 
//el       (
//el        (cmd (run-multilang (file-name-nondirectory (buffer-file-name))))
//el        ) ;; let-binds
//el     (progn
//el       (message cmd)
//el       (shell-command cmd)
//el       (mlang/revert)
